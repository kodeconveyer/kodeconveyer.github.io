# Traffic Sign Classifier - Privacy Policy
...
Collecting and using the following data will require your consent, unless it is collected to ensure security, prevent fraud or debug:
